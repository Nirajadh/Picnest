...
Partial Class Form3
    ...
    Private Sub InitializeComponent()
        ...
        ' Guna2Button4
        ' 
        Guna2Button4.Anchor = AnchorStyles.Bottom Or AnchorStyles.Left
        Guna2Button4.AnimatedGIF = True
        Guna2Button4.BackColor = Color.FromArgb(CByte(0), CByte(1), CByte(217), CByte(124))
        ...
        Guna2Button4.CustomImages.ImageOffset = New Point(0, -2)
        Guna2Button4.CustomImages.ImageSize = New Size(26, 26)
        ...
        btngallery.CustomImages.Image = CType(resources.GetObject("resource.Image1"), Image)
        ...
        btnedit.CustomImages.Image = CType(resources.GetObject("resource.Image2"), Image)
        ...
        btnhome.CustomImages.Image = CType(resources.GetObject("resource.Image3"), Image)
