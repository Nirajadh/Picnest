...
Partial Class edit1
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(edit1))
        ...
        btncroprevert = New Guna.UI2.WinForms.Guna2Button()
        btncropapply = New Guna.UI2.WinForms.Guna2Button()
        btnrotateright = New Guna.UI2.WinForms.Guna2Button()
        btncrop = New Guna.UI2.WinForms.Guna2Button()
        panelcrop = New Guna.UI2.WinForms.Guna2Panel()
        Guna2PictureBox1 = New Guna.UI2.WinForms.Guna2PictureBox()
        btnfilterinvert = New Guna.UI2.WinForms.Guna2Button()
        btnfiltersharpen = New Guna.UI2.WinForms.Guna2Button()
        btnfilterblur = New Guna.UI2.WinForms.Guna2Button()
        ...
        pnlupload = New Guna.UI2.WinForms.Guna2Panel()
        saveconfirmbtn = New Guna.UI2.WinForms.Guna2Button()
        captiontxtbox = New Guna.UI2.WinForms.Guna2TextBox()
        ...
        PictureBox1.Size = New Size(972, 572)
        ...
        ' btnadjust
        ' 
        btnadjust.AnimatedGIF = True
        btnadjust.BackColor = Color.Black
        btnadjust.BorderRadius = 10
        btnadjust.BorderThickness = 2
        btnadjust.ButtonMode = Guna.UI2.WinForms.Enums.ButtonMode.RadioButton
        ...
        btnadjust.CustomImages.Image = CType(resources.GetObject("resource.Image"), Image)
        ...
        btnadjust.CustomizableEdges = CustomizableEdges5
        ...
        btnadjust.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        btnadjust.FillColor = SystemColors.Control
        btnadjust.Font = New Font("Segoe UI", 9F)
        btnadjust.ForeColor = Color.White
        btnadjust.HoverState.BorderColor = SystemColors.Control
        btnadjust.HoverState.FillColor = Color.White
        btnadjust.Location = New Point(6, 186)
        btnadjust.Name = "btnadjust"
        btnadjust.PressedDepth = 10
        btnadjust.ShadowDecoration.CustomizableEdges = CustomizableEdges6
        btnadjust.Size = New Size(55, 47)
        btnadjust.TabIndex = 3
        ' 
        ' btncropopen
        ' 
        btncropopen.BackColor = Color.Black
        btncropopen.BorderRadius = 10
        btncropopen.BorderThickness = 2
        ...
        btncropopen.CustomImages.Image = CType(resources.GetObject("resource.Image1"), Image)
        ...
        btncropopen.CustomizableEdges = CustomizableEdges7
        ...
        btncropopen.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        btncropopen.FillColor = SystemColors.Control
        btncropopen.Font = New Font("Segoe UI", 9F)
        btncropopen.ForeColor = Color.White
        btncropopen.HoverState.BorderColor = SystemColors.Control
        btncropopen.HoverState.FillColor = Color.White
        btncropopen.Location = New Point(6, 107)
        btncropopen.Name = "btncropopen"
        btncropopen.PressedDepth = 40
        btncropopen.ShadowDecoration.CustomizableEdges = CustomizableEdges8
        btncropopen.Size = New Size(55, 47)
        btncropopen.TabIndex = 2
        ' 
        ' filterbtn
        ' 
        filterbtn.BackColor = Color.Black
        filterbtn.BorderRadius = 10
        filterbtn.BorderThickness = 2
        filterbtn.ButtonMode = Guna.UI2.WinForms.Enums.ButtonMode.RadioButton
        filterbtn.CheckedState.BorderColor = Color.White
        filterbtn.CheckedState.FillColor = Color.White
        filterbtn.CustomImages.Image = My.Resources.Resources.noun_photo_filter_4180800
        ...
        filterbtn.CustomizableEdges = CustomizableEdges9
        ...
        filterbtn.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        filterbtn.FillColor = SystemColors.Control
        filterbtn.Font = New Font("Segoe UI", 9F)
        filterbtn.ForeColor = Color.White
        filterbtn.HoverState.BorderColor = SystemColors.Control
        filterbtn.HoverState.FillColor = Color.White
        filterbtn.Location = New Point(6, 28)
        filterbtn.Name = "filterbtn"
        filterbtn.PressedDepth = 40
        filterbtn.ShadowDecoration.CustomizableEdges = CustomizableEdges10
        filterbtn.Size = New Size(55, 47)
        ...
        Guna2Panel2.Location = New Point(1, 197)
        Guna2Panel2.Name = "Guna2Panel2"
        Guna2Panel2.ShadowDecoration.CustomizableEdges = CustomizableEdges12
        Guna2Panel2.Size = New Size(67, 260)
        ...
        btncroprevert.CustomizableEdges = CustomizableEdges13
        ...
        btncroprevert.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        btncroprevert.FillColor = Color.WhiteSmoke
        btncroprevert.Font = New Font("Segoe UI", 9F)
        btncroprevert.ForeColor = Color.White
        btncroprevert.HoverState.BorderColor = Color.Transparent
        btncroprevert.HoverState.FillColor = Color.Transparent
        btncroprevert.Location = New Point(15, 17)
        btncroprevert.Name = "btncroprevert"
        btncroprevert.ShadowDecoration.CustomizableEdges = CustomizableEdges14
        ...
        btncropapply.CustomizableEdges = CustomizableEdges15
        ...
        btncropapply.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        btncropapply.FillColor = Color.WhiteSmoke
        btncropapply.Font = New Font("Segoe UI", 9F)
        btncropapply.ForeColor = Color.White
        btncropapply.HoverState.BorderColor = Color.Transparent
        btncropapply.HoverState.FillColor = Color.Transparent
        btncropapply.Location = New Point(917, 17)
        btncropapply.Name = "btncropapply"
        btncropapply.ShadowDecoration.CustomizableEdges = CustomizableEdges16
        ...
        btnrotateright.CustomizableEdges = CustomizableEdges17
        ...
        btnrotateright.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        btnrotateright.FillColor = Color.WhiteSmoke
        btnrotateright.Font = New Font("Segoe UI", 9F)
        btnrotateright.ForeColor = Color.White
        btnrotateright.HoverState.BorderColor = Color.Transparent
        btnrotateright.HoverState.FillColor = Color.Transparent
        btnrotateright.Location = New Point(515, 22)
        btnrotateright.Name = "btnrotateright"
        btnrotateright.ShadowDecoration.CustomizableEdges = CustomizableEdges18
        ...
        btncrop.CustomizableEdges = CustomizableEdges19
        ...
        btncrop.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        btncrop.FillColor = Color.WhiteSmoke
        btncrop.Font = New Font("Segoe UI", 9F)
        btncrop.ForeColor = Color.White
        btncrop.HoverState.BorderColor = Color.Transparent
        btncrop.HoverState.FillColor = Color.Transparent
        btncrop.Location = New Point(419, 14)
        btncrop.Name = "btncrop"
        btncrop.ShadowDecoration.CustomizableEdges = CustomizableEdges20
        btncrop.Size = New Size(66, 47)
        btncrop.TabIndex = 3
        ' 
        ' panelcrop
        ' 
        panelcrop.BackColor = Color.Transparent
        panelcrop.BorderRadius = 15
        panelcrop.BorderThickness = 1
        panelcrop.Controls.Add(btncroprevert)
        panelcrop.Controls.Add(btncropapply)
        panelcrop.Controls.Add(btnrotateright)
        panelcrop.Controls.Add(btncrop)
        panelcrop.CustomizableEdges = CustomizableEdges21
        panelcrop.Dock = DockStyle.Bottom
        panelcrop.FillColor = Color.Black
        panelcrop.Location = New Point(0, 503)
        panelcrop.Name = "panelcrop"
        panelcrop.ShadowDecoration.CustomizableEdges = CustomizableEdges22
        panelcrop.Size = New Size(975, 75)
        panelcrop.TabIndex = 4
        panelcrop.UseTransparentBackground = True
        ...
        ' btnfilterinvert
        ' 
        btnfilterinvert.BorderThickness = 1
        btnfilterinvert.CustomizableEdges = CustomizableEdges25
        btnfilterinvert.DisabledState.BorderColor = Color.DarkGray
        btnfilterinvert.DisabledState.CustomBorderColor = Color.DarkGray
        btnfilterinvert.DisabledState.FillColor = Color.FromArgb(CByte(169), CByte(169), CByte(169))
        btnfilterinvert.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        btnfilterinvert.FillColor = Color.Transparent
        btnfilterinvert.Font = New Font("Segoe UI", 9F)
        btnfilterinvert.ForeColor = Color.White
        btnfilterinvert.ImageOffset = New Point(1, 1)
        btnfilterinvert.ImageSize = New Size(75, 65)
        btnfilterinvert.Location = New Point(738, 6)
        btnfilterinvert.Name = "btnfilterinvert"
        btnfilterinvert.ShadowDecoration.CustomizableEdges = CustomizableEdges26
        btnfilterinvert.Size = New Size(75, 65)
        btnfilterinvert.TabIndex = 21
        ' 
        ' btnfiltersharpen
        ' 
        btnfiltersharpen.BorderThickness = 1
        btnfiltersharpen.CustomizableEdges = CustomizableEdges27
        btnfiltersharpen.DisabledState.BorderColor = Color.DarkGray
        btnfiltersharpen.DisabledState.CustomBorderColor = Color.DarkGray
        btnfiltersharpen.DisabledState.FillColor = Color.FromArgb(CByte(169), CByte(169), CByte(169))
        btnfiltersharpen.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        btnfiltersharpen.FillColor = Color.Transparent
        btnfiltersharpen.Font = New Font("Segoe UI", 9F)
        btnfiltersharpen.ForeColor = Color.White
        btnfiltersharpen.ImageOffset = New Point(1, 1)
        btnfiltersharpen.ImageSize = New Size(75, 65)
        btnfiltersharpen.Location = New Point(595, 6)
        btnfiltersharpen.Name = "btnfiltersharpen"
        btnfiltersharpen.ShadowDecoration.CustomizableEdges = CustomizableEdges28
        btnfiltersharpen.Size = New Size(75, 65)
        btnfiltersharpen.TabIndex = 20
        ' 
        ' btnfilterblur
        ' 
        btnfilterblur.BorderThickness = 1
        btnfilterblur.CustomizableEdges = CustomizableEdges29
        btnfilterblur.DisabledState.BorderColor = Color.DarkGray
        btnfilterblur.DisabledState.CustomBorderColor = Color.DarkGray
        btnfilterblur.DisabledState.FillColor = Color.FromArgb(CByte(169), CByte(169), CByte(169))
        btnfilterblur.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        btnfilterblur.FillColor = Color.Transparent
        btnfilterblur.Font = New Font("Segoe UI", 9F)
        btnfilterblur.ForeColor = Color.White
        btnfilterblur.ImageOffset = New Point(1, 1)
        btnfilterblur.ImageSize = New Size(75, 65)
        btnfilterblur.Location = New Point(452, 6)
        btnfilterblur.Name = "btnfilterblur"
        btnfilterblur.ShadowDecoration.CustomizableEdges = CustomizableEdges30
        btnfilterblur.Size = New Size(75, 65)
        btnfilterblur.TabIndex = 19
        ' 
        ' btnfilterrevert
        ' 
        btnfilterrevert.BorderColor = Color.Transparent
        btnfilterrevert.BorderRadius = 5
        btnfilterrevert.CustomImages.Image = CType(resources.GetObject("resource.Image6"), Image)
        ...
        btnfilterrevert.CustomizableEdges = CustomizableEdges31
        ...
        btnfilterrevert.Location = New Point(15, 21)
        btnfilterrevert.Name = "btnfilterrevert"
        btnfilterrevert.ShadowDecoration.CustomizableEdges = CustomizableEdges32
        ...
        btnapply.CustomImages.Image = CType(resources.GetObject("resource.Image7"), Image)
        ...
        btnapply.CustomizableEdges = CustomizableEdges33
        ...
        btnapply.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        btnapply.FillColor = Color.WhiteSmoke
        btnapply.Font = New Font("Segoe UI", 9F)
        btnapply.ForeColor = Color.White
        btnapply.HoverState.BorderColor = Color.Transparent
        btnapply.HoverState.FillColor = Color.Transparent
        btnapply.Location = New Point(917, 19)
        btnapply.Name = "btnapply"
        btnapply.ShadowDecoration.CustomizableEdges = CustomizableEdges34
        btnapply.Size = New Size(45, 35)
        btnapply.TabIndex = 6
        ' 
        ' btnfiltergray
        ' 
        btnfiltergray.BorderThickness = 1
        btnfiltergray.CustomizableEdges = CustomizableEdges35
        ...
        btnfiltergray.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        btnfiltergray.FillColor = Color.Transparent
        btnfiltergray.Font = New Font("Segoe UI", 9F)
        btnfiltergray.ForeColor = Color.White
        btnfiltergray.ImageOffset = New Point(1, 1)
        btnfiltergray.ImageSize = New Size(75, 65)
        btnfiltergray.Location = New Point(309, 6)
        btnfiltergray.Name = "btnfiltergray"
        btnfiltergray.ShadowDecoration.CustomizableEdges = CustomizableEdges36
        btnfiltergray.Size = New Size(75, 65)
        btnfiltergray.TabIndex = 1
        ' 
        ' btnfiltersepia
        ' 
        btnfiltersepia.BorderThickness = 1
        btnfiltersepia.CustomizableEdges = CustomizableEdges37
        ...
        btnfiltersepia.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        btnfiltersepia.FillColor = Color.Transparent
        btnfiltersepia.Font = New Font("Segoe UI", 9F)
        btnfiltersepia.ForeColor = Color.White
        btnfiltersepia.ImageOffset = New Point(1, 1)
        btnfiltersepia.ImageSize = New Size(75, 65)
        btnfiltersepia.Location = New Point(166, 6)
        btnfiltersepia.Name = "btnfiltersepia"
        btnfiltersepia.ShadowDecoration.CustomizableEdges = CustomizableEdges38
        btnfiltersepia.Size = New Size(75, 65)
        btnfiltersepia.TabIndex = 0
        btnfiltersepia.UseTransparentBackground = True
        ' 
        ' btnadjustrevert
        ' 
        btnadjustrevert.BorderColor = Color.Transparent
        btnadjustrevert.BorderRadius = 5
        btnadjustrevert.CustomImages.Image = CType(resources.GetObject("resource.Image8"), Image)
        ...
        btnadjustrevert.CustomizableEdges = CustomizableEdges39
        ...
        btnadjustrevert.Location = New Point(15, 21)
        btnadjustrevert.Name = "btnadjustrevert"
        btnadjustrevert.ShadowDecoration.CustomizableEdges = CustomizableEdges40
        ...
        Guna2HtmlLabel3.Location = New Point(696, 50)
        ...
        Guna2HtmlLabel1.Location = New Point(459, 50)
        ...
        ' trackbarcontrast
        ' 
        trackbarcontrast.BackColor = Color.Transparent
        trackbarcontrast.FillColor = Color.Gainsboro
        trackbarcontrast.Location = New Point(401, 20)
        ...
        trackbarcontrast.ThumbColor = Color.White
        trackbarcontrast.Value = 0
        ' 
        ' trackbarbrightness
        ' 
        trackbarbrightness.BackColor = Color.Transparent
        trackbarbrightness.FillColor = Color.Gainsboro
        trackbarbrightness.Location = New Point(159, 20)
        trackbarbrightness.Minimum = -100
        trackbarbrightness.Name = "trackbarbrightness"
        trackbarbrightness.Size = New Size(175, 24)
        trackbarbrightness.TabIndex = 9
        trackbarbrightness.ThumbColor = Color.White
        ...
        btnadjustapply.CustomImages.Image = CType(resources.GetObject("resource.Image9"), Image)
        ...
        btnadjustapply.CustomizableEdges = CustomizableEdges41
        ...
        btnadjustapply.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        btnadjustapply.FillColor = Color.WhiteSmoke
        btnadjustapply.Font = New Font("Segoe UI", 9F)
        btnadjustapply.ForeColor = Color.White
        btnadjustapply.HoverState.BorderColor = Color.Transparent
        btnadjustapply.HoverState.FillColor = Color.Transparent
        btnadjustapply.Location = New Point(917, 23)
        btnadjustapply.Name = "btnadjustapply"
        btnadjustapply.ShadowDecoration.CustomizableEdges = CustomizableEdges42
        ...
        paneladjust.CustomizableEdges = CustomizableEdges45
        paneladjust.Dock = DockStyle.Bottom
        paneladjust.FillColor = Color.Black
        paneladjust.Location = New Point(0, 349)
        paneladjust.Name = "paneladjust"
        paneladjust.ShadowDecoration.CustomizableEdges = CustomizableEdges46
        paneladjust.Size = New Size(975, 76)
        paneladjust.TabIndex = 3
        paneladjust.Visible = False
        ' 
        ' trackbarsaturation
        ' 
        trackbarsaturation.BackColor = Color.Transparent
        trackbarsaturation.FillColor = Color.Gainsboro
        trackbarsaturation.Location = New Point(644, 20)
        ...
        trackbarsaturation.ThumbColor = Color.White
        trackbarsaturation.Value = 0
        ' 
        ' Guna2Panel1
        ' 
        Guna2Panel1.BackColor = Color.Transparent
        Guna2Panel1.Controls.Add(paneladjust)
        Guna2Panel1.Controls.Add(panelfilters)
        Guna2Panel1.Controls.Add(panelcrop)
        Guna2Panel1.Controls.Add(Guna2PictureBox1)
        Guna2Panel1.Controls.Add(PictureBox1)
        Guna2Panel1.Controls.Add(pnlupload)
        Guna2Panel1.CustomizableEdges = CustomizableEdges57
        Guna2Panel1.FillColor = Color.Transparent
        Guna2Panel1.ForeColor = Color.Transparent
        Guna2Panel1.Location = New Point(70, 0)
        Guna2Panel1.Name = "Guna2Panel1"
        Guna2Panel1.ShadowDecoration.CustomizableEdges = CustomizableEdges58
        Guna2Panel1.Size = New Size(975, 654)
        ...
        panelfilters.Controls.Add(btnfilterinvert)
        panelfilters.Controls.Add(btnfiltersharpen)
        panelfilters.Controls.Add(btnfilterblur)
        ...
        panelfilters.FillColor = Color.Black
        panelfilters.Location = New Point(0, 425)
        panelfilters.Name = "panelfilters"
        panelfilters.ShadowDecoration.CustomizableEdges = CustomizableEdges48
        panelfilters.Size = New Size(975, 78)
        panelfilters.TabIndex = 5
        panelfilters.UseTransparentBackground = True
        panelfilters.Visible = False
        ' 
        ' pnlupload
        ' 
        pnlupload.BackColor = Color.Transparent
        pnlupload.BorderColor = Color.Transparent
        pnlupload.BorderRadius = 15
        pnlupload.BorderThickness = 1
        pnlupload.Controls.Add(saveconfirmbtn)
        pnlupload.Controls.Add(captiontxtbox)
        pnlupload.Controls.Add(uploadbtn)
        pnlupload.CustomizableEdges = CustomizableEdges55
        pnlupload.Dock = DockStyle.Bottom
        pnlupload.FillColor = Color.Black
        pnlupload.Location = New Point(0, 578)
        pnlupload.Name = "pnlupload"
        pnlupload.ShadowDecoration.CustomizableEdges = CustomizableEdges56
        pnlupload.Size = New Size(975, 76)
        pnlupload.TabIndex = 7
        ' 
        ' saveconfirmbtn
        ' 
        saveconfirmbtn.BorderColor = Color.Transparent
        ...
        saveconfirmbtn.DisabledState.FillColor = Color.FromArgb(CByte(169), CByte(169), CByte(169))
        saveconfirmbtn.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        saveconfirmbtn.FillColor = Color.WhiteSmoke
        saveconfirmbtn.Font = New Font("Segoe UI", 9F)
        saveconfirmbtn.ForeColor = Color.White
        saveconfirmbtn.HoverState.BorderColor = Color.Transparent
        saveconfirmbtn.HoverState.FillColor = Color.Transparent
        saveconfirmbtn.Location = New Point(917, 21)
        saveconfirmbtn.Name = "saveconfirmbtn"
        saveconfirmbtn.ShadowDecoration.CustomizableEdges = CustomizableEdges50
        saveconfirmbtn.Size = New Size(45, 35)
        saveconfirmbtn.TabIndex = 9
        saveconfirmbtn.Visible = False
        ' 
        ' captiontxtbox
        ' 
        captiontxtbox.CustomizableEdges = CustomizableEdges51
        captiontxtbox.DefaultText = ""
        captiontxtbox.DisabledState.BorderColor = Color.FromArgb(CByte(208), CByte(208), CByte(208))
        captiontxtbox.DisabledState.FillColor = Color.FromArgb(CByte(226), CByte(226), CByte(226))
        captiontxtbox.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        captiontxtbox.DisabledState.PlaceholderForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        captiontxtbox.FocusedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        captiontxtbox.Font = New Font("Segoe UI", 9F)
        captiontxtbox.ForeColor = Color.Black
        captiontxtbox.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        captiontxtbox.Location = New Point(322, 18)
        captiontxtbox.Margin = New Padding(3, 4, 3, 4)
        captiontxtbox.Name = "captiontxtbox"
        captiontxtbox.PasswordChar = ChrW(0)
        captiontxtbox.PlaceholderForeColor = Color.Black
        captiontxtbox.PlaceholderText = "Enter Caption"
        captiontxtbox.SelectedText = ""
        captiontxtbox.ShadowDecoration.CustomizableEdges = CustomizableEdges52
        captiontxtbox.Size = New Size(331, 41)
        captiontxtbox.TabIndex = 5
        captiontxtbox.Visible = False
        ' 
        ' uploadbtn
        ' 
        uploadbtn.BackColor = Color.Black
        uploadbtn.BorderColor = Color.White
        uploadbtn.BorderRadius = 20
        uploadbtn.BorderThickness = 2
        uploadbtn.CheckedState.FillColor = Color.Gray
        uploadbtn.CustomBorderColor = Color.White
        uploadbtn.CustomImages.Image = My.Resources.Resources.icons8_add_image_301
        uploadbtn.CustomImages.ImageAlign = HorizontalAlignment.Left
        uploadbtn.CustomImages.ImageSize = New Size(26, 26)
        uploadbtn.CustomizableEdges = CustomizableEdges53
        ...
        uploadbtn.FillColor = Color.WhiteSmoke
        uploadbtn.Font = New Font("Segoe UI", 9F)
        uploadbtn.ForeColor = Color.Black
        uploadbtn.HoverState.BorderColor = Color.Black
        uploadbtn.HoverState.FillColor = Color.White
        uploadbtn.HoverState.ForeColor = Color.Black
        uploadbtn.ImageOffset = New Point(20, 10)
        uploadbtn.Location = New Point(409, 15)
        uploadbtn.Name = "uploadbtn"
        uploadbtn.ShadowDecoration.CustomizableEdges = CustomizableEdges54
        uploadbtn.Size = New Size(156, 47)
        uploadbtn.TabIndex = 4
        uploadbtn.Text = "Upload image"
        uploadbtn.TextAlign = HorizontalAlignment.Right
        ' 
        ...
        Guna2Button1.CustomImages.Image = CType(resources.GetObject("resource.Image11"), Image)
        Guna2Button1.CustomImages.ImageAlign = HorizontalAlignment.Center
        Guna2Button1.CustomImages.ImageOffset = New Point(0, -2)
        ...
        Guna2Button1.Size = New Size(45, 35)
    ...
    Friend WithEvents btnadjust As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents btncropopen As Guna.UI2.WinForms.Guna2Button
    ...
    Friend WithEvents btncropapply As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents btnrotateright As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents btncrop As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents panelcrop As Guna.UI2.WinForms.Guna2Panel
    Friend WithEvents Guna2PictureBox1 As Guna.UI2.WinForms.Guna2PictureBox
    Friend WithEvents btnfilterinvert As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents btnfiltersharpen As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents btnfilterblur As Guna.UI2.WinForms.Guna2Button
    ...
    Friend WithEvents btnfiltergray As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents btnfiltersepia As Guna.UI2.WinForms.Guna2Button
    ...
    Friend WithEvents paneladjust As Guna.UI2.WinForms.Guna2Panel
    ...
    Friend WithEvents captiontxtbox As Guna.UI2.WinForms.Guna2TextBox
    Friend WithEvents saveconfirmbtn As Guna.UI2.WinForms.Guna2Button
